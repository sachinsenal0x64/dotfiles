...
$env.config = {
    ...
    cursor_shape: {
        ...
        vi_normal: blink_line # block, underscore, line, blink_block, blink_underscore, blink_line, inherit to skip setting cursor shape (underscore is the default)
    }
...
print ''
export-env { $env.PF_INFO = 'ascii title os wm editor shell kernel uptime palette' }
export-env {$env.CLIPBOARD_NOAUDIO = '1'}
...
alias su = sudo -E nu
alias icat = ~/dotfiles/scripts/image.sh
